...
library(tidyverse)
library(Rcpp)
sourceCpp("./simulation-code/ff_n400_quad/unireg_indep.cpp")
sourceCpp("./simulation-code/ff_n400_quad/profile_new.cpp")
##################simulation##############################################
...
p_ff_quad_n400 = ggplot(data = df) +
  ...
  labs(x = "Covariate", y = "Cumulative statistic", title = "Additional quadratic term, n = 400") +
  scale_x_continuous(limits = c(0,3), breaks = seq(0,3,0.3), expand = expansion(0,0)) +
...
p_ff_quad_n400
save(p_ff_quad_n400, file = "./output/FigureS1/ff_quad_n400_graph_plot.RData")  
