...
p_ff_twisted_n400 = ggplot(data = df) +
  theme_light() +
  ...
  labs(x = "Covariate", y = "Cumulative statistic", title = "Twisted functional form, n = 400") +
...
p_ff_twisted_n400
save(p_ff_twisted_n400, file = "./output/FigureS1/ff_twisted_n400_graph_plot.RData")  
