...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/ff_n800_twisted/unireg_indep.cpp")
sourceCpp("./simulation-code/ff_n800_twisted/profile_new.cpp")
##################simulation##############################################
...
p_ff_twisted_n800 = ggplot(data = df) +
  theme_light() +
  ...
  labs(x = "Covariate", y = "Cumulative statistic", title = "Twisted functional form, n = 800") +
