...
library(tidyverse)
library(Rcpp)
sourceCpp("./simulation-code/ff_n800_quad/unireg_indep.cpp")
sourceCpp("./simulation-code/ff_n800_quad/profile_new.cpp")
##################simulation##############################################
...
p_ff_quad_n800 = ggplot(data = df) +
  ...
  labs(x = "Covariate", y = "Cumulative statistic", title = "Additional quadratic term, n = 800") +
...
p_ff_quad_n800
save(p_ff_quad_n800, file = "./output/FigureS1/ff_quad_n800_graph_plot.RData")  
