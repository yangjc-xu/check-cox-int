...
library(tidyverse)
library(Rcpp)
sourceCpp("./simulation-code/ff_n200_quad/unireg_indep.cpp")
sourceCpp("./simulation-code/ff_n200_quad/profile_new.cpp")
##################simulation##############################################
...
p_ff_quad_n200 = ggplot(data = df) +
  ...
  labs(x = "Covariate", y = "Cumulative statistic", title = "Additional quadratic term, n = 200") +
