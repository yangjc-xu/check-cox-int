...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prop_n200_quad/unireg_indep.cpp")
sourceCpp("./simulation-code/prop_n200_quad/profile_dep_fast.cpp")
##################simulation##############################################
...
p_prop_quad_n200 = ggplot(data = df) +
  theme_light() +
  ...
  labs(x = "Time", y = "Cumulative statistic", title = "Quadratic log hazard ratio, n = 200") +
