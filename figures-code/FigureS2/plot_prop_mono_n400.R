...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prop_n400_mono/unireg_indep.cpp")
sourceCpp("./simulation-code/prop_n400_mono/profile_dep_fast.cpp")
##################simulation##############################################
...
p_prop_mono_n400 = ggplot(data = df) +
  theme_light() +
  ...
  labs(x = "Time", y = "Cumulative statistic", title = "Monotone hazard ratio, n = 400") +
