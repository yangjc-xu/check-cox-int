...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prop_n200_mono/unireg_indep.cpp")
sourceCpp("./simulation-code/prop_n200_mono/profile_dep_fast.cpp")
##################simulation##############################################
...
p_prop_mono_n200 = ggplot(data = df) +
  theme_light() +
  ...
  labs(x = "Time", y = "Cumulative statistic", title = "Monotone hazard ratio, n = 200") +
