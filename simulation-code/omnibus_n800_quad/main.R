...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/omnibus_n800_quad/unireg_indep.cpp")
sourceCpp("./simulation-code/omnibus_n800_quad/profile_dep_fast.cpp")
##################simulation##############################################
