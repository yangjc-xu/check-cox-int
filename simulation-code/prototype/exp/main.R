...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prototype/exp/unireg_indep.cpp")
sourceCpp("./simulation-code/prototype/exp/profile_new.cpp")
##################simulation##############################################
...
save(W_score_all, x, t, file = "./output/Figure1/exp_raw.RData")
