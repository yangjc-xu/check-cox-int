...
set.seed(seed)
filename <- c("test.RData")
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prototype/quad/unireg_indep.cpp")
sourceCpp("./simulation-code/prototype/quad/profile_new.cpp")
##################simulation##############################################
...
save(W_score_all, x, t, file = "./output/Figure1/quad_raw.RData")
