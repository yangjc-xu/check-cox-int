...
library(dplyr)
library(Rcpp)
sourceCpp("./simulation-code/prototype/ind/unireg_indep.cpp")
sourceCpp("./simulation-code/prototype/ind/profile_new.cpp")
##################simulation##############################################
...
SimIntData = function(n_sample, r){
  ...
  linear_term = beta[2] * powerx(X2, r)
...
save(W_score_all, x, t, file = "./output/Figure1/ind_raw.RData")
