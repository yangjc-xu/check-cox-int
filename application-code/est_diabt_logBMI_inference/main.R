...
save(std_Age, std_BMI, std_Glucose, std_SysBP, std_DiaBP, file = "scale_diabt_logBMI_inference.RData")
...
save(result_aric, X_aric, simpdat_aric, Time_aric, file = "result_estimation_diabt_logBMI_inference.RData")