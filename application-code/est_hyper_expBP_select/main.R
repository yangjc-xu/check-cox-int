...
dat_select$SysBP = exp(dat_select$SysBP)
dat_select$DiaBP = exp(dat_select$DiaBP)
...
save(std_Age, std_BMI, std_Glucose, std_SysBP, std_DiaBP, file = "../scale_hyper_expBP_select.RData")
...
save(result_aric, X_aric, simpdat_aric, Time_aric, file = "result_estimation_hyper_expBP_select.RData")
